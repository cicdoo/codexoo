...
/**
 * Subscribes once to the "codexoo" bus notifications and fans them out to
...
export const aiAssistantService = {
    ...
    start(env, { bus_service }) {
        ...
        bus_service.subscribe("codexoo", (payload) => {
...
registry.category("services").add("codexoo", aiAssistantService);
